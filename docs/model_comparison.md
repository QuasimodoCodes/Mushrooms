...
| **Epochs to Converge**     | [TBD] epochs           | 50 epochs              | [TBD]   |
...
> **Attach Graphs:** You can drag and drop your `results.png` or `confusion_matrix.png` from `docs/yolo_runs/mushroom_classifier_v1/` right here!
