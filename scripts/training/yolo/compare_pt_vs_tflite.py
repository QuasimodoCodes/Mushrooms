...
def main():
    ...
    pt_path     = os.path.join(base, "docs", "yolo_runs", "yolo26_classifier_v1", "weights", "best.pt")
    tflite_path = os.path.join(base, "docs", "yolo_runs", "yolo26_tflite", "weights", "best_float16.tflite")
    output_dir  = os.path.join(base, "docs", "yolo_runs", "yolo26_tflite")
